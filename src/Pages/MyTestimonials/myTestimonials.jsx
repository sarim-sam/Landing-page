...
const MyTestimonials = () => {
  ...
  return (
    ...
    <img
      src="/myGroup.png"
      alt="Background"
      className="absolute inset-0 left-5 z-0 max-w[1600px] -full max-h-[580px] hidden sm:hidden md:block"
    />
...
<div className='2xl:hidden xl:hidden lg:hidden md:hidden sm:block'>
  ...
  <div className="flex flex-col lg:flex-row md:flex-col sm:flex-col xs:flex-col ls:flex-col ms:flex-col items-center justify-around w-full mx-2 sm:mx-4 mb-8 z-10 2xl:-mx-16">
  {/* Heading */}
  ...
  <div className="flex gap-4 sm:gap-6">
    ...
    <button
      onClick={handleNext}
      className="w-20 h-20 rounded-full bg-[#684fff] hover:bg-[#836fff] flex items-center justify-center transform transition-transform duration-300 hover:scale-110 active:scale-95"
    >
      <svg width="86" height="85" viewBox="0 0 86 85" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1" y="0.5" width="84" height="84" rx="42" fill="#684FFF" />
        <rect x="1" y="0.5" width="84" height="84" rx="42" stroke="" />
