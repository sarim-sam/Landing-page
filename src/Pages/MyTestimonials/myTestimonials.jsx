...
const TestimonialCard = ({ name, title, image, icon, quote }) => {
  return (
    <div className="group max-w-xl sxl:p-10 sxl:mt-2 lg:p-10 lg:mt-2 rounded-[30px] shadow-lg bg-white relative transform transition-transform duration-300 hover:scale-105 hover:bg-[#684fff] hover:text-white active:scale-110 will-change-transform">
