...
<div className="flex flex-col z-10 lg:flex-row items-center lg:items-start justify-center w-full mx-2 sm:mx-4 mb-8">
  {/* Heading */}
  ...
  {/* LEFT BUTTON */}
    ...
    >
      <svg width="86" height="85" viewBox="0 0 86 85" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="0.5" width="85" height="85" rx="42.5" fill="#e8e9eb"/>
